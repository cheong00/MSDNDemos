...
namespace WinFirewall
{
    public class FWCtrl
    {
        ...
        public void Setup()
        {
            ...
            newRule.Description = "Block inbound traffic from 192.168.0.2 over TCP port 1001,3000-4000";
            newRule.Protocol = (int) NET_FW_IP_PROTOCOL_.NET_FW_IP_PROTOCOL_TCP;
            newRule.LocalPorts = "1001,3000-4000";
            newRule.Direction = NET_FW_RULE_DIRECTION_.NET_FW_RULE_DIR_IN;
            newRule.RemoteAddresses = "192.168.0.2";
            newRule.Enabled = true;
            //newRule.Grouping = "@firewallapi.dll,-23255";
            newRule.Grouping = "Firewall test app";
